<?php
/**
 * BossMerchantNetInStandardApiRespDTO
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * BossMerchantNetInStandardApiRespDTO Class Doc Comment
 *
 * @category Class
 * @description 老板管账标准版特约商户入网（企业/个体）返回参数
 * @package  Yeepay\Yop\Sdk\
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BossMerchantNetInStandardApiRespDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BossMerchantNetInStandardApiRespDTO';
     ...
     * Sets msg
     *
     * @param string $msg <p>响应消息</p> <p>\"申请已驳回\"时，回传的审核意见</p>
     *
     * @return $this
     */
