...
/**
 * BankAccountBenefitInfoSnDTO Class Doc Comment
 *
 * @category Class
 * @description 苏宁银行受益人信息
 * @package  Yeepay\Yop\Sdk\
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BankAccountBenefitInfoSnDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BankAccountBenefitInfoSnDTO';
     ...
     * Sets benefitName
     *
     * @param string $benefitName <pre>受益人姓名</pre>
     *
     * @return $this
     */
     ...
     * Sets benefitIdType
     *
     * @param string $benefitIdType <pre>选项如下：<br />ID_CARD：身份证</pre>
     *
     * @return $this
     */
     ...
     * Sets benefitIdNo
     *
     * @param string $benefitIdNo <pre>受益人证件号码</pre>
     *
     * @return $this
     */
     ...
     *
     * @param string $benefitStartDate <pre>受益人证件生效日期，支持格式：yyyyMMdd</pre>
     *
     * @return $this
     */
     ...
     *
     * @param string $benefitExpireDate <pre>受益人证件失效日期，<br />支持格式为：yyyyMMdd,forever(长期有效)</pre>
     *
     * @return $this
     */
     ...
     *
     * @param string $benefitImageFont <pre>受益人证件照正面</pre>
     *
     * @return $this
     */
     ...
     *
     * @param string $benefitImageBack <pre>受益人证件照反面</pre>
     *
     * @return $this
     */
     ...
     * Sets benefitAddress
     *
     * @param string $benefitAddress <pre>受益人地址</pre>
     *
     * @return $this
     */
