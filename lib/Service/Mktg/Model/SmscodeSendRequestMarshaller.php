...
class SmscodeSendRequestMarshaller implements RequestMarshaller
{
    /**
     * @var SmscodeSendRequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new SmscodeSendRequestMarshaller();
    }

    /**
     * @return SmscodeSendRequestMarshaller
     */
     ...
     * @var string
     */
    private $resourcePath = '/rest/v1.0/mktg/smscode/send';
...
SmscodeSendRequestMarshaller::__init();
