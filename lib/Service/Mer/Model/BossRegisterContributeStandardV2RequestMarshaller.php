...
class BossRegisterContributeStandardV2RequestMarshaller implements RequestMarshaller
{
    /**
     * @var BossRegisterContributeStandardV2RequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new BossRegisterContributeStandardV2RequestMarshaller();
    }

    /**
     * @return BossRegisterContributeStandardV2RequestMarshaller
     */
    ...
    /**
     * @param BossRegisterContributeStandardV2Request $request
     * @return Request
     */
...
BossRegisterContributeStandardV2RequestMarshaller::__init();
