<?php
/**
 * AccountBookUnFreezeBalanceResponseDTO
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * AccountBookUnFreezeBalanceResponseDTO Class Doc Comment
 *
 * @category Class
 * @description 请修改我
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AccountBookUnFreezeBalanceResponseDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AccountBookUnFreezeBalanceResponseDTO';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['orgRequestNo'] = isset($data['orgRequestNo']) ? $data['orgRequestNo'] : null;
     ...
     * Sets requestNo
     *
     * @param string $requestNo <p>解冻请求号</p>
     *
     * @return $this
     */
    ...
    {
        return $this->container['orgRequestNo'];
    }

    /**
     * Sets orgRequestNo
     *
     * @param string $orgRequestNo <p>原冻结请求号</p>
     *
     * @return $this
     */
    public function setOrgRequestNo($orgRequestNo)
    {
        $this->container['orgRequestNo'] = $orgRequestNo;
     ...
     * Sets status
     *
     * @param string $status <p>解冻状态</p> 可选项如下: SUCCESS:成功 PROCESSING:处理中 FAIL:失败
     *
     * @return $this
     */
