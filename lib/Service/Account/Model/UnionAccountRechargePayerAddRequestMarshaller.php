...
class UnionAccountRechargePayerAddRequestMarshaller implements RequestMarshaller
{
    /**
     * @var UnionAccountRechargePayerAddRequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new UnionAccountRechargePayerAddRequestMarshaller();
    }

    /**
     * @return UnionAccountRechargePayerAddRequestMarshaller
     */
     ...
     * @var string
     */
    private $resourcePath = '/rest/v1.0/account/recharge/payer-add';
    ...
    /**
     * @param UnionAccountRechargePayerAddRequest $request
     * @return Request
     */
    public function marshal($request)
    {
        ...
        if($request->getApplyDataUrl() != null){
            $internalRequest->addParameter('applyDataUrl', ObjectSerializer::sanitizeForSerialization($request->getApplyDataUrl(), 'string'));
        }
...
UnionAccountRechargePayerAddRequestMarshaller::__init();
