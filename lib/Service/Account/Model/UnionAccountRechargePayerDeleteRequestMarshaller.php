...
class UnionAccountRechargePayerDeleteRequestMarshaller implements RequestMarshaller
{
    /**
     * @var UnionAccountRechargePayerDeleteRequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new UnionAccountRechargePayerDeleteRequestMarshaller();
    }

    /**
     * @return UnionAccountRechargePayerDeleteRequestMarshaller
     */
     ...
     * @var string
     */
    private $resourcePath = '/rest/v1.0/account/recharge/payer-delete';
    ...
    /**
     * @param UnionAccountRechargePayerDeleteRequest $request
     * @return Request
     */
...
UnionAccountRechargePayerDeleteRequestMarshaller::__init();
