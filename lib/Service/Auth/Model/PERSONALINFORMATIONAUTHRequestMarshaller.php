...
class PERSONALINFORMATIONAUTHRequestMarshaller implements RequestMarshaller
{
    /**
     * @var PERSONALINFORMATIONAUTHRequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new PERSONALINFORMATIONAUTHRequestMarshaller();
    }

    /**
     * @return PERSONALINFORMATIONAUTHRequestMarshaller
     */
    ...
    /**
     * @param PERSONALINFORMATIONAUTHRequest $request
     * @return Request
     */
...
PERSONALINFORMATIONAUTHRequestMarshaller::__init();
