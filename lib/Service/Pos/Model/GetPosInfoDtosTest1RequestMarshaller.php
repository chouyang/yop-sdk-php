...
class GetPosInfoDtosTest1RequestMarshaller implements RequestMarshaller
{
    /**
     * @var GetPosInfoDtosTest1RequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new GetPosInfoDtosTest1RequestMarshaller();
    }

    /**
     * @return GetPosInfoDtosTest1RequestMarshaller
     */
     ...
     * @var string
     */
    private $resourcePath = '/rest/v1.0/pos/get-pos-info-dtos-test1';
    ...
    /**
     * @param GetPosInfoDtosTest1Request $request
     * @return Request
     */
...
GetPosInfoDtosTest1RequestMarshaller::__init();
