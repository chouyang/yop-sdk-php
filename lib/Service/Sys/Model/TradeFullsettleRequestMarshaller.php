...
class TradeFullsettleRequestMarshaller implements RequestMarshaller
{
    /**
     * @var TradeFullsettleRequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new TradeFullsettleRequestMarshaller();
    }

    /**
     * @return TradeFullsettleRequestMarshaller
     */
     ...
     * @var string
     */
    private $resourcePath = '/rest/v1.0/sys/trade/fullsettle';
    ...
    /**
     * @param TradeFullsettleRequest $request
     * @return Request
     */
...
TradeFullsettleRequestMarshaller::__init();
