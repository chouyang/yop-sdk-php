...
class BindcardRequestV21RequestMarshaller implements RequestMarshaller
{
    /**
     * @var BindcardRequestV21RequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new BindcardRequestV21RequestMarshaller();
    }

    /**
     * @return BindcardRequestV21RequestMarshaller
     */
     ...
     * @var string
     */
    private $resourcePath = '/rest/v2.1/frontcashier/bindcard/request';
    ...
    /**
     * @param BindcardRequestV21Request $request
     * @return Request
     */
...
BindcardRequestV21RequestMarshaller::__init();
