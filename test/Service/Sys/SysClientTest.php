...
class SysClientTest extends TestCase
{
     ...
     * @test
     */
    public function tradeDividequeryTest()
    {
        $request = new Model\TradeDividequeryRequest();
        ...
        $request->setHmac("hmac_example");
        try{
            $response = self::$client->tradeDividequery($request);
            print_r($response->getResult());
        }catch (\Exception $e) {
     ...
     * @test
     */
    public function tradeFullsettleTest()
    {
        $request = new Model\TradeFullsettleRequest();
        ...
        $request->setHmac("hmac_example");
        try{
            $response = self::$client->tradeFullsettle($request);
            print_r($response->getResult());
        }catch (\Exception $e) {
