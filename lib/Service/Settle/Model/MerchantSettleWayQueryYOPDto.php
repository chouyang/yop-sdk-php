...
/**
 * MerchantSettleWayQueryYOPDto Class Doc Comment
 *
 * @category Class
 * @description 未命名
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MerchantSettleWayQueryYOPDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MerchantSettleWayQueryYOPDto';
     ...
     * Sets settleRatio
     *
     * @param double $settleRatio 该结算方向对应的结算比例。单位：%，两位小数。如返回80.00，则表示结算资金的80.00%（四舍五入后保留两位小数）将结算至相应结算方向。
     *
     * @return $this
     */
     ...
     * Sets bankCardNo
     *
     * @param string $bankCardNo 结算卡号<br>结算方向为结算到银行卡时返回
     *
     * @return $this
     */
     ...
     * Sets accountName
     *
     * @param string $accountName 银行卡账户名<br>结算方向为结算到银行卡时返回
     *
     * @return $this
     */
