...
class TravelResourcesClientBuilder
{
    ...
    public static function __init()
    {
        ...
        self::$authorizationReqRegistry->register('createRefundOrder', AuthorizationReqSupport::getAuthorizationReq('YOP-RSA2048-SHA256'));
        ...
        self::$authorizationReqRegistry->register('queryPayOrder', AuthorizationReqSupport::getAuthorizationReq('YOP-RSA2048-SHA256'));
        self::$authorizationReqRegistry->register('queryRefundOrder', AuthorizationReqSupport::getAuthorizationReq('YOP-RSA2048-SHA256'));
    }
