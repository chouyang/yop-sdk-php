...
class AccountBookBalanceFreezeRequestMarshaller implements RequestMarshaller
{
    /**
     * @var AccountBookBalanceFreezeRequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new AccountBookBalanceFreezeRequestMarshaller();
    }

    /**
     * @return AccountBookBalanceFreezeRequestMarshaller
     */
    ...
    /**
     * @param AccountBookBalanceFreezeRequest $request
     * @return Request
     */
...
AccountBookBalanceFreezeRequestMarshaller::__init();
