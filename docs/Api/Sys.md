...
[**tradeDividequery**](Sys.md#tradeDividequery) | **POST** /rest/v1.0/sys/trade/dividequery | 订单处理器——分账查询
[**tradeFullsettle**](Sys.md#tradeFullsettle) | **POST** /rest/v1.0/sys/trade/fullsettle | 订单处理器——资金全额确认
...
# **tradeDividequery**
TradeDividequeryResponse tradeDividequery(TradeDividequeryRequest request)
...
$api_client = Yeepay\Yop\Sdk\Service\Sys\SysClientBuilder::builder()->build();
$request = new Yeepay\Yop\Sdk\Service\Sys\Model\TradeDividequeryRequest();
$request->setParentMerchantNo("parentMerchantNo_example");
$request->setMerchantNo("merchantNo_example");
$request->setOrderId("orderId_example");
$request->setUniqueOrderNo("uniqueOrderNo_example");
...
try {
    $response = $api_client->tradeDividequery($request);
    print_r($response->getResult());
}catch (\Exception $e) {
    echo 'Exception when calling SysClient->tradeDividequery: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
### Return type
[**\Yeepay\Yop\Sdk\Service\Sys\Model\TradeDividequeryYopQueryOrderDivideResDTOResult**](../Model/TradeDividequeryYopQueryOrderDivideResDTOResult.md)
### Authorization
...
# **tradeFullsettle**
TradeFullsettleResponse tradeFullsettle(TradeFullsettleRequest request)

订单处理器——资金全额确认

<p>如果因业务需要在订单创建时，资金处理类型为延迟结算的场合，使用本接口解除延迟结算（一般用在担保交易场景）</p>
...
$api_client = Yeepay\Yop\Sdk\Service\Sys\SysClientBuilder::builder()->build();
$request = new Yeepay\Yop\Sdk\Service\Sys\Model\TradeFullsettleRequest();
$request->setParentMerchantNo("parentMerchantNo_example");
$request->setMerchantNo("merchantNo_example");
$request->setOrderId("orderId_example");
$request->setUniqueOrderNo("uniqueOrderNo_example");
...
try {
    $response = $api_client->tradeFullsettle($request);
    print_r($response->getResult());
}catch (\Exception $e) {
    echo 'Exception when calling SysClient->tradeFullsettle: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
### Return type
[**\Yeepay\Yop\Sdk\Service\Sys\Model\TradeFullsettleYopOrderFundFullySettleResDTOResult**](../Model/TradeFullsettleYopOrderFundFullySettleResDTOResult.md)
### Authorization
