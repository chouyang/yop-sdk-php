...
class InstallmentPayRequestV11RequestMarshaller implements RequestMarshaller
{
    /**
     * @var InstallmentPayRequestV11RequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new InstallmentPayRequestV11RequestMarshaller();
    }

    /**
     * @return InstallmentPayRequestV11RequestMarshaller
     */
     ...
     * @var string
     */
    private $resourcePath = '/rest/v1.1/cnppay/installment/pay/request';
    ...
    /**
     * @param InstallmentPayRequestV11Request $request
     * @return Request
     */
...
InstallmentPayRequestV11RequestMarshaller::__init();
