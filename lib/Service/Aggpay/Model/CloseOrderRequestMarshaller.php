...
class CloseOrderRequestMarshaller implements RequestMarshaller
{
    /**
     * @var CloseOrderRequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new CloseOrderRequestMarshaller();
    }

    /**
     * @return CloseOrderRequestMarshaller
     */
...
CloseOrderRequestMarshaller::__init();
