...
class AuthClientBuilder
{
    ...
    public static function __init()
    {
        ...
        self::$authorizationReqRegistry->register('pERSONAL_INFORMATION_AUTH', AuthorizationReqSupport::getAuthorizationReq('YOP-RSA2048-SHA256'));
        self::$authorizationReqRegistry->register('personAuth', AuthorizationReqSupport::getAuthorizationReq('YOP-RSA2048-SHA256'));
    }
