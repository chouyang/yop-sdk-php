...
class TradeDividequeryRequestMarshaller implements RequestMarshaller
{
    /**
     * @var TradeDividequeryRequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new TradeDividequeryRequestMarshaller();
    }

    /**
     * @return TradeDividequeryRequestMarshaller
     */
     ...
     * @var string
     */
    private $resourcePath = '/rest/v1.0/sys/trade/dividequery';
    ...
    /**
     * @param TradeDividequeryRequest $request
     * @return Request
     */
...
TradeDividequeryRequestMarshaller::__init();
