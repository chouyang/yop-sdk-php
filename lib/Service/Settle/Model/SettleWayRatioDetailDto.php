...
/**
 * SettleWayRatioDetailDto Class Doc Comment
 *
 * @category Class
 * @description 未命名
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SettleWayRatioDetailDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SettleWayRatioDetailDto';
     ...
     * Sets settleWay
     *
     * @param string $settleWay 结算方向<br>可选项如下:<br>BANKCARD:结算至银行卡<br>ACCOUNT:结算至资金账户
     *
     * @return $this
     */
     ...
     * Sets settleRatio
     *
     * @param float $settleRatio 该结算方向对应的结算比例。单位：%，两位小数。最小值：0.00，最大值：100.00。单一方向到账时，该字段传入100.00;多方向到账时，传入各结算比例之和需为100.00。如传入80.00，则表示结算资金的80.00%（四舍五入后保留两位小数）将结算至相应结算方向
     *
     * @return $this
     */
     ...
     * Sets bankCardNo
     *
     * @param string $bankCardNo 银行卡号<br>结算方向为结算到银行卡时必填。该银行卡需已经添加为结算卡。
     *
     * @return $this
     */
