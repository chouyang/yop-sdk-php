...
class RegisterContributeWebIndexV2RequestMarshaller implements RequestMarshaller
{
    /**
     * @var RegisterContributeWebIndexV2RequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new RegisterContributeWebIndexV2RequestMarshaller();
    }

    /**
     * @return RegisterContributeWebIndexV2RequestMarshaller
     */
     ...
     * @var string
     */
    private $resourcePath = '/rest/v2.0/mer/register/contribute/web/index';
    ...
    /**
     * @param RegisterContributeWebIndexV2Request $request
     * @return Request
     */
...
RegisterContributeWebIndexV2RequestMarshaller::__init();
