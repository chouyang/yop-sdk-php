...
class OrderRequestMarshaller implements RequestMarshaller
{
    ...
    public function marshal($request)
    {
        ...
        if($request->getCommercePlatform() != null){
            $internalRequest->addParameter('commercePlatform', ObjectSerializer::sanitizeForSerialization($request->getCommercePlatform(), 'string'));
        }
        if($request->getPyeeBankAccountType() != null){
            $internalRequest->addParameter('pyeeBankAccountType', ObjectSerializer::sanitizeForSerialization($request->getPyeeBankAccountType(), 'string'));
        }
        if($request->getPyeeBankCode() != null){
            $internalRequest->addParameter('pyeeBankCode', ObjectSerializer::sanitizeForSerialization($request->getPyeeBankCode(), 'string'));
        }
        if($request->getPyeeAccountName() != null){
            $internalRequest->addParameter('pyeeAccountName', ObjectSerializer::sanitizeForSerialization($request->getPyeeAccountName(), 'string'));
        }
        if($request->getPyeeAccountNo() != null){
            $internalRequest->addParameter('pyeeAccountNo', ObjectSerializer::sanitizeForSerialization($request->getPyeeAccountNo(), 'string'));
        }
