...
class UnionAccountTradeAccountBookRemitRequestMarshaller implements RequestMarshaller
{
    /**
     * @var UnionAccountTradeAccountBookRemitRequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new UnionAccountTradeAccountBookRemitRequestMarshaller();
    }

    /**
     * @return UnionAccountTradeAccountBookRemitRequestMarshaller
     */
    ...
    /**
     * @param UnionAccountTradeAccountBookRemitRequest $request
     * @return Request
     */
...
UnionAccountTradeAccountBookRemitRequestMarshaller::__init();
