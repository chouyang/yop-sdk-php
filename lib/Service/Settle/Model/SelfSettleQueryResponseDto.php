...
/**
 * SelfSettleQueryResponseDto Class Doc Comment
 *
 * @category Class
 * @description 响应结果
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SelfSettleQueryResponseDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SelfSettleQueryResponseDto';
     ...
     * Sets code
     *
     * @param string $code 返回码<br>成功：000000<br>其他错误码参加错误码描述
     *
     * @return $this
     */
     ...
     *
     * @param float $settlableAmount 商户可结算金额。商户可结算但未结算的金额
     *
     * @return $this
     */
     ...
     *
     * @param float $unsettledAmount 未结算金额。未结算金额=可结算但未结算的金额+不可结算金额（未到结算周期的交易汇总金额）
     *
     * @return $this
     */
