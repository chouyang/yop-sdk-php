...
class TravelResourcesClient
{
    ...
    /**
     * @param Model\CreateRefundOrderRequest $request
     * @return Model\CreateRefundOrderResponse
     * @throws YopClientException
     */
    public function createRefundOrder(Model\CreateRefundOrderRequest $request)
    {
        if ($request == null) {
            throw new YopClientException("request is required.");
        }
        $clientExecutionParams = new ClientExecutionParams($request, Model\CreateRefundOrderRequestMarshaller::getInstance(),
            Model\CreateRefundOrderResponseUnMarshaller::getInstance());
        return $this->clientHandler->execute($clientExecutionParams);
    }
    /**
    ...
    /**
     * @param Model\QueryPayOrderRequest $request
     * @return Model\QueryPayOrderResponse
     * @throws YopClientException
     */
    public function queryPayOrder(Model\QueryPayOrderRequest $request)
    {
        if ($request == null) {
            throw new YopClientException("request is required.");
        }
        $clientExecutionParams = new ClientExecutionParams($request, Model\QueryPayOrderRequestMarshaller::getInstance(),
            Model\QueryPayOrderResponseUnMarshaller::getInstance());
        return $this->clientHandler->execute($clientExecutionParams);
    }
    /**
     * @param Model\QueryRefundOrderRequest $request
     * @return Model\QueryRefundOrderResponse
     * @throws YopClientException
     */
    public function queryRefundOrder(Model\QueryRefundOrderRequest $request)
    {
        if ($request == null) {
            throw new YopClientException("request is required.");
        }
        $clientExecutionParams = new ClientExecutionParams($request, Model\QueryRefundOrderRequestMarshaller::getInstance(),
            Model\QueryRefundOrderResponseUnMarshaller::getInstance());
        return $this->clientHandler->execute($clientExecutionParams);
    }
}
