...
class GroupAccountTransferRequestMarshaller implements RequestMarshaller
{
    /**
     * @var GroupAccountTransferRequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new GroupAccountTransferRequestMarshaller();
    }

    /**
     * @return GroupAccountTransferRequestMarshaller
     */
    ...
    /**
     * @param GroupAccountTransferRequest $request
     * @return Request
     */
...
GroupAccountTransferRequestMarshaller::__init();
