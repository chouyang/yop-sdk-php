...
class SettleRecordDetailsDto implements ModelInterface, ArrayAccess
{
     ...
     * Sets status
     *
     * @param string $status <p>到账状态</p> <div> <pre>INIT:待处理</pre> <div> <pre>REMIT_PROCESS:银行处理中</pre> <div> <pre>REMIT_FAIL:出款失败</pre> <div> <pre>ACCOUNTING_FAIL:出款失败</pre> </div> <div> <pre>REMIT_SUCCESS:已到账</pre> </div> <div> <pre>SUCCESS:已到账</pre> <p>&nbsp;</p> </div> </div> </div> </div>
     *
     * @return $this
     */
     ...
     * Sets reverseTime
     *
     * @param \DateTime $reverseTime <p>冲退时间</p>
     *
     * @return $this
     */
