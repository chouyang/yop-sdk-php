...
class ReprocessClientTest extends TestCase
{
     ...
     * @test
     */
    public function migrate_bank_order_v1_0Test()
    {
        $request = new Model\MigrateBankOrderV10Request();
        ...
        $request->setMerchantNo("merchantNo_example");
        try{
            $response = self::$client->migrate_bank_order_v1_0($request);
            print_r($response->getResult());
        }catch (\Exception $e) {
     ...
     * @test
     */
    public function migrate_bank_query_v1_0Test()
    {
        $request = new Model\MigrateBankQueryV10Request();

        $request->setMigrateRequestId("migrateRequestId_example");
        $request->setParentMerchantNo("parentMerchantNo_example");
        $request->setMerchantNo("merchantNo_example");
        try{
            $response = self::$client->migrate_bank_query_v1_0($request);
            print_r($response->getResult());
        }catch (\Exception $e) {
