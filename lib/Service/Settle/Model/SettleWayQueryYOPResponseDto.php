...
/**
 * SettleWayQueryYOPResponseDto Class Doc Comment
 *
 * @category Class
 * @description 响应结果
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SettleWayQueryYOPResponseDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SettleWayQueryYOPResponseDto';
    ...
    protected static $swaggerTypes = [
        ...
        'merchantSettleWayQueryDtos' => '\Yeepay\Yop\Sdk\Service\Settle\Model\MerchantSettleWayQueryYOPDto[]'
    ];
     ...
     * Sets status
     *
     * @param string $status 处理状态<br>可选项如下:<br>SUCCESS:成功<br>FAIL:失败
     *
     * @return $this
     */
     ...
     * Sets code
     *
     * @param string $code 返回码<br>000000为成功，其他为失败
     *
     * @return $this
     */
     ...
     *
     * @return \Yeepay\Yop\Sdk\Service\Settle\Model\MerchantSettleWayQueryYOPDto[]
     */
     ...
     *
     * @param \Yeepay\Yop\Sdk\Service\Settle\Model\MerchantSettleWayQueryYOPDto[] $merchantSettleWayQueryDtos merchantSettleWayQueryDtos
     *
     * @return $this
     */
